                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($this->session->userdata('admin')){ ?>
                                            <div class="all-form-element-inner">
                                                <form action="<?= base_url() ?>home/proses_insertproyek/" method="post" enctype="multipart/form-data">
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="id_proyek" readonly value="PRO-<?= time();?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Nama Penanggung Jawab</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select type="text" name="pj" class="form-control">
                                                                    <option value="">-- Silahkan Pilih Penanggung Jawab --</option>
                                                                    <?php foreach($penanggung_jawab as $row){ ?>
                                                                        <option value="<?= $row['id_pengguna'] ?>">ID : <?= $row['id_pengguna'] ?> ---- NAMA : <?= $row['nama'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Durasi</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        ...
                                                                        <button class="btn btn-sm btn-input " type="submit">Save Change</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <?php } ?>
                                        <?php if($this->session->userdata('pj')){ ?>
                                            <div class="all-form-element-inner">
                                                <form action="<?= base_url() ?>home/proses_insertproyek/" method="post" enctype="multipart/form-data">
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" readonly value="<?= $this->session->userdata('users');?>" class="form-control">
                                                                <input type="hidden" value="<?= $this->session->userdata('id');?>" name="pj">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
