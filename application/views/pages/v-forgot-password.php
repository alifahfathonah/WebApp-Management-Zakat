					...
					<div class="left">
						<div class="content">
							<div class="header">
								...
								<p class="lead">Lupa Kata Sandi Anda?</p>
                            </div>
							...
							<form class="form-auth-small"  method="post">
								<div class="form-group">  
                                    ...
                                    <input type="email" class="form-control" id="signin-email" name="email"  value="" placeholder="Masukan Email ...">
								...
								<button type="submit" name="submit" style="background-color:#078171;color:#fff; border-color:#078171;" class="btn btn-success btn-lg btn-block">Reset Kata Sandi</button>
								<div class="bottom">
									<span class="helper-text"><i class="fa fa-share"></i> <a href="<?= base_url(); ?>login/">Login Kembali</a></span>
								</div>
							</form>
						</div>
					</div>
